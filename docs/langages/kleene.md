...
Dans ce chapitre, on fait le lien entre **les langages réguliers**, qu'on peut dénoter par expression régulière, et les **langages reconnaissables** par automate fini.
