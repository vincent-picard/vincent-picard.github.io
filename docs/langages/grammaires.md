...
!!! definition "Grammaires algébriques"
    Une **grammaire algébrique** est un quadruplet (Sigma, V, S, R) dans lequel :
        ...
        - S est une variable de V appelée axiome
        - R est un ensemble _fini_ de **règles de production** : une règle de production est un couple (X, u) où X est une variable et u un mot sur Sigma union V
